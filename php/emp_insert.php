...
<form action="emp_insert_1.php" method="post">
	...
	<div class="emp_main">	
		<span style="color: white; font-size: 64px;font-family: sans-serif;">Employee Details</span>
		<div class="admin_center">
			...
			<input type="email" name="email" placeholder="abc.domain.com (E-Mail)" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite; color: black;"><br><br>
