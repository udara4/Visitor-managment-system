...
<link rel="stylesheet" href="../css/createpass_1.css">
 ...
 <form action="new_1.php" method="post" name="form1">
...
<tbody>
<tr>
        <td style="margin-left: 22px; display: none;" align="right">S\n no :</td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px; display: none;" required><input type="Number" value="<?php echo $fetch[0]?>" name="id" readonly="readonly" placeholder="Id" style="width: 70%; height: 30px; color: #000; border-radius: 10px;border:none;margin-left: 22px; padding: 5px; margin-top: 18px;" required><br><br></td>
</tr>
<tr>
        <td style="margin-left: 22px;" align="right">ID no :</td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required><input type="Number" value="<?php echo $fetch[3]?>" name="ic1" readonly="readonly" placeholder="Id" style="width: 70%; height: 30px; color: #000; border-radius: 10px;border:none;margin-left: 22px; padding: 5px; margin-top: 18px;" required><br><br></td>
</tr>
    <tr>
	    <td style="margin-left: 22px;" align="right">Name :</td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required><input type="text" name="name1"  placeholder="Name" value="<?php echo $fetch[1]?>"  style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required></td>
</tr>
	<tr>
        <td style="margin-left: 22px;" align="right">Address :</td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required><input type="text" name="address1" placeholder="Address" value="<?php echo $fetch[12]?>" style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required><br><br></td>
</tr>
	
	
	<tr>
	    <td style="margin-left: 22px;" align="right">Phone no : </td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required><input type="Number" name="phone"  placeholder="Phone No"  value="<?php echo $fetch[4]?>" style="width: 70%; height: 30px; color: #000; border-radius: 10px;border:none;
		margin-left: 22px; padding: 5px; margin-top: 18px;"><br><br></td>
    </tr>
	<tr>
	    <td style="margin-left: 22px; display: none; " align="right">Gender :</td>
		<td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px; display: none;" required><input type="text" value="<?php echo $fetch[2]?>" name="gender" readonly="readonly" placeholder="gender" style="width: 70%; height: 30px; color: #000; border-radius: 10px;border:none;margin-left: 22px; padding: 5px; margin-top: 18px;" required><br><br></td>
	...
	<tr>
        <td style="margin-left: 22px;" align="right">Reason : </td>
        <td style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;" required>	<div style="margin-top: -8px; margin-left: 60px;" required>                 
		<select name="person_meet"  style="width: 80%; height: 30px; border-radius: 10px;border:none; margin-left: -40px; padding: 5px; margin-top: 10px; color: #000">
		<?php                          
		include ('dbconn.php');
